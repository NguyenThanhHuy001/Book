...
@WebServlet(urlPatterns= {"/system/logout"})
public class LogoutSystemController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.sendRedirect(request.getContextPath() + "/views/system/login.jsp");
	}
